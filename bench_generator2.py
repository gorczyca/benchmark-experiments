...
OUTPUT_CSV_LOC = 'results_gen_s.csv' 
INST_GOAL_CSV_LOC = 'inst_goal.csv'
...
if __name__ == '__main__':
    ...
    for i, combination in enumerate(combinations):
        ...
        for j, g in enumerate(goals):
            ...
            print(f'{i} - {j}/{all_size}')


            with open(INST_GOAL_CSV_LOC, 'a') as f:
                f.write(f'{output_file_name},{g}\n')
                print('wrote inst goal pair')
            ...
            flex_result, flex_time_needed = get_solver_result('flexaspic', TIMEOUT, flex_benchmark_loc, g, 'adm')
