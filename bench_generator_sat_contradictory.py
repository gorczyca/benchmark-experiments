...
ASPFORASPIC_BENCHMARKS_LOC = 'instances/contradictories/aspforaspic'
FLEXASPIC_BENCHMARKS_LOC = 'instances/contradictories/flexaspic'


OUTPUT_CSV_LOC = 'results_gen_sat_contradictories.csv' 
...
def create_framework_contradictories(n_sentences, proc_axioms, proc_premises, max_rules_per_head,
    ...
    return Framework(premises, axioms, remaining_sentences, all_sentences, {}, all_contraries, strict_rules, def_rules)
...
if __name__ == '__main__':
    ...
    while sat_count < sat_instances_number:
        ...
        for i, combination in enumerate(combinations):
            ...
            framework = create_framework_contradictories(statements_, axioms_perc_, premises_perc_, max_rules_per_statement_, max_sentences_per_body_, max_contraries_per_statement_, defeasible_rules_ratio_, def_rule_contrary_ratio_, atom_contrary_ratio_)
            ...
            for j, g in enumerate(goals):
                ...
                with open(OUTPUT_CSV_LOC, 'a') as f:
                    # f.write(f'{output_file_name},{g},{asp_result},{asp_time_needed},{flex_result},{flex_time_needed}\n')
