...
ASPFORASPIC_BENCHMARKS_LOC = 'instances/nonflat/aspforaspic'
FLEXASPIC_BENCHMARKS_LOC = 'instances/nonflat/flexaspic'


OUTPUT_CSV_LOC = 'results_gen_sat_nonflat.csv' 
