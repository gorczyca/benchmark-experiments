...
% option(frameworkdir, '/home/piotr/Dresden/aspic-flexdds/experiments/benchmark/abagraph/frameworks/').
option(frameworkdir, 'frameworks').
...
fw_loop(N_FW, N_FWs, Method, FileStem, Options) :-  %   [N_Ss_IN, N_As_IN, N_RHs_IN, N_RsPH_IN, N_SsPB_IN, N_AsPB_IN]
 ...
 make_rules(Method, [O_Ss,O_As,O_NonAs], [N_Ss,N_As,N_NonAs], Options, Rs),
